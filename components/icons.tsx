...
export function ChatIcon({ size = 24, width, height, ...props }: IconSvgProps) {
  return (
    <svg
...
export function HashTag({ size = 24, width, height, ...props }: IconSvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      aria-hidden="true"
...
export function SpeakerIcon({ size = 24, width, height, ...props }: IconSvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      aria-hidden="true"
...
export function BackIcon({ size = 24, width, height, ...props }: IconSvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      aria-hidden="true"
